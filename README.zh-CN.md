...
> 预发布状态：Phase 14 发布政策校准与 exact-candidate 收口正在进行，产品 runtime 已冻结。USER 已批准版本 0.1.0、unsigned portable 分发和 v0.1.0 cold/warm startup 550 ms hard boundary（180 ms 为 preferred，400 ms 为诊断性 engineering target）。真实输入法、视觉、任务栏/Alt+Tab、托盘、显示器、恢复、Clean VM 与远端 artifact 门仍开放；当前不宣称 RC-ready 或 stable-ready。
