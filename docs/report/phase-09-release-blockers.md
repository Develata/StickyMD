...
| --- | --- | --- | --- | --- |
| RB-001 | P0 | Warm startup exceeds its hard gate | Final graceful-exit cohort: cold p95 277.205 ms PASS at the original 300 ms gate; warm p95 342.891 ms FAIL at 180 ms. No warm waiver exists. | OPEN |
...
| RB-007 | P0 | Phase 9 package/SBOM/license pipeline | exact clean-source package contains 187-package runtime notices; ZIP/SBOM checksums, verifier and copied-runtime matrix pass | CLOSED |
| RB-008 | P0 | Release workflow and supply-chain pins | cargo-deny uses Cargo checksum-verified installation; actionlint, governance and PowerShell parse pass; remote execution remains NOT EXECUTED | CLOSED LOCALLY |
