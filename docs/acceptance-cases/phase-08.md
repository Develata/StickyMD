...
| P08-A03 | AC-019..021 dock geometry | Automated | `phase8_` tests cover 12-DIP snap, greater-than-16-DIP undock, 3-DIP strip and left/right/top work-area geometry | AUTOMATED PASS |
...
| P08-A16 | Phase 8 copied-Release lifecycle | Automated | [`phase-08.ps1 -Runtime`](../../tools/smoke/phase-08.ps1) drives real left/top/right snap-collapse-reveal, both top-corner priority cases, WM_CLOSE and same-directory wake; exact `Top > Left > Right` geometry ties also have deterministic reducer coverage | AUTOMATED PASS |
