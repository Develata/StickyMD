...
| P08-A16 | Phase 8 copied-Release lifecycle | Automated | [`phase-08.ps1 -Runtime`](../../tools/smoke/phase-08.ps1) drives real WM_CLOSE, observes hidden HWND, launches a same-directory wake instance and re-observes the original HWND | AUTOMATED PASS |
