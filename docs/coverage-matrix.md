...
| `11_testing_and_release.md` | 逐阶段验证、发布形态 | `phase-00.md`..`phase-08.md`、release 验收清单 | `stickymd-smoke`; `tools/smoke/*.ps1`; Windows CI | Rust 合并任务图 + Phase 0–8 稳定入口已实现；CI runs the headless graph and excludes real-desktop resource modes；人工门见各 Phase 矩阵 |
