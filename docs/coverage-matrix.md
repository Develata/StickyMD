...
| `11_testing_and_release.md` | 逐阶段验证、JSON evidence、发布形态 | `phase-00.md`..`phase-11.md`、`phase-11-b.md`、release 验收清单 | `tools/stickymd-smoke`; `tools/smoke/*.ps1`; `.github/workflows/ci.yml` | Rust task/gate/evidence authority, schema-v2 raw samples/gates, Phase 11-B route and CI headless de-duplication tests PASS；manual modes remain excluded/NOT TESTED |
