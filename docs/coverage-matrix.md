...
| `11_testing_and_release.md` | 逐阶段验证、发布形态 | `phase-00.md`..`phase-09.md`、release 验收清单 | `stickymd-smoke`; `tools/smoke/*.ps1`; Windows CI | Phase 0–9 CLI/PowerShell routes, exact-RC package/SBOM and workflow static audit implemented；CI fail-closes on warm-start status；manual modes remain excluded/NOT TESTED |
