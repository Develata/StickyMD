...
| `10_performance_reliability.md` | 质量属性 | AC-022、AC-032、空闲/内存观察、P14-A03/A08/A15/A23 | core/source/preview/math/image/export/window/zoom Release baselines；`stickymd-smoke` copied-runtime metrics/attribution；`docs/report/phase-14-memory-attribution.md` | v0.1.0 采用 180 preferred / 400 engineering diagnostic / 550 hard 三层 startup policy；Release Source/Preview/Split 归因完成；拒绝以频繁重建换取小幅 Source 降幅，tray-hidden document projection 改为完整释放；新 exact candidate 仍需完整资源重跑 |
