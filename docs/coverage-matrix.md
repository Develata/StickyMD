...
| `10_performance_reliability.md` | 质量属性 | AC-022、空闲/内存观察 | core/source/preview/math/image/export Release baselines | Phase 7 scanner/paste/decode/export Release baselines and bounded 16 MiB image cache automated；OS resource receipt in Phase 7 report；manual visual/IME gates remain open |
| `11_testing_and_release.md` | 逐阶段验证、发布形态 | `phase-00.md`..`phase-07.md`、release 验收清单 | `stickymd-smoke`; `tools/smoke/*.ps1`; Windows CI | Rust 合并任务图 + Phase 0–7 稳定入口已实现；CI runs headless graph；人工门见各 Phase 矩阵 |
