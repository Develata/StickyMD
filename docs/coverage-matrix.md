...
| `11_testing_and_release.md` | 逐阶段验证、exact-artifact JSON evidence、发布形态 | `phase-00.md`..`phase-14.md`、release 验收清单 | `tools/stickymd-smoke`; `tools/smoke/*.ps1`; `.github/workflows/ci.yml`; `dist/evidence/*` | Rust task/gate/evidence authority, independent channel collection、Tier A/B/C readiness、G1..G3 guided manual、unsigned receipt contract；dynamic/manual evidence pending exact Phase 14 candidate |
