...
| `10_performance_reliability.md` | 质量属性 | AC-022、AC-032、空闲/内存观察、P14-A03/A08 | core/source/preview/math/image/export/window/zoom Release baselines；`stickymd-smoke` copied-runtime metrics/attribution | v0.1.0 采用 180 preferred / 400 engineering diagnostic / 550 hard 三层 startup policy；Phase 14 exact candidate 重新测量并归因 |
